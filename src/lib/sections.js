...
export function NavSimple({
  ...
  const fontVars = getFontVariables([
    headingFont,
    bodyFont
  ])
  ...
  return (
    <section className={fontVars} style={{ padding: '80px 32px' }}>
      <h1
        style={{
          fontFamily: `var(--font-${headingFont})`,
          fontSize: '48px',
...
// PROPERTY HERO
// Scope: PROPERTY
// Props: overlayOpacity, accentColor
//
// Showcases: property data (photos, title, address, price, sale_status)
// passed directly as a prop — no fetch inside the component.
// ---------------------------------------------------------------------------
...
function Spec({ label, value }) {
  return (
    <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.15)', padding: '8px 16px', borderRadius: '6px' }}>
